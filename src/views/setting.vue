...
<template>
  <el-drawer v-model="settingStore.settingShow" direction="rtl" size="360px">
    ...
    <template #default>
      <div class="left_shu">大屏跳转</div>
      <div class="setting_item">
        <span class="setting_label"> 选择大屏: </span>
        <div class="setting_content">
          <el-select
            ...
            size="large"
            style="width: 240px"
            @change="async (url) => await goToPath(url)"
          >
            <el-option
      ...
      <div class="setting_item">
        <span class="setting_label">
          是否自动查询: <span class="setting_label_tip"></span>
        </span>
        <div class="setting_content">
          <el-radio-group
      ...
      <div class="setting_item">
        <span class="setting_label"> 自动查询间隔: </span>
        <div class="setting_content">
          <el-radio-group
            v-model="rightBottomRadio"
            @change="(flag)=>indexRadioChange(flag as boolean)"
          >
            <el-radio :label="true">5分钟</el-radio>
            <el-radio :label="false">30分钟</el-radio>
          </el-radio-group>
        </div>
      </div>
    </template>
